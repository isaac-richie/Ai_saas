...
export default function SettingsPage() {
    return (
        <div className="mx-auto w-full max-w-6xl space-y-7 py-2 md:py-4">
            <section data-reveal="hero" className="rounded-3xl border border-white/10 bg-[#0b0b0d] p-6 text-white shadow-[0_20px_40px_-35px_rgba(0,0,0,0.9)] md:p-8">
